...
INSERT INTO TBL_CHILD
(ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID)
VALUES(SEQ_CHILD.NEXTVAL, '마이콜', 4, 2, 6);
INSERT INTO TBL_CHILD
(ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID)
VALUES(SEQ_CHILD.NEXTVAL, '짱구', 5, 2, 7);
INSERT INTO TBL_CHILD
(ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID)
VALUES(SEQ_CHILD.NEXTVAL, '짱아', 5, 1, 7);
INSERT INTO TBL_CHILD
(ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID)
VALUES(SEQ_CHILD.NEXTVAL, '신형만', 12, 1, 8);

SELECT * FROM TBL_CHILD;

INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 5, 8);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 5, 8);
INSERT INTO TBL_APPLY
...
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 6, 10);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 7, 11);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
...
INSERT INTO TBL_FIELD_TRIP(ID, FIELD_TRIP_TITLE, FIELD_TRIP_CONTENT, KINDERGARTEN_ID)
VALUES(SEQ_FIELD_TRIP.NEXTVAL, '아이스크림 빨리 먹기 대회', '아이스크림 누가 더 잘먹나', 22);
INSERT INTO TBL_FIELD_TRIP(ID, FIELD_TRIP_TITLE, FIELD_TRIP_CONTENT, KINDERGARTEN_ID)
VALUES(SEQ_FIELD_TRIP.NEXTVAL, '고구마 심기', '고구마가 왕 커요', 23);
INSERT INTO TBL_FIELD_TRIP(ID, FIELD_TRIP_TITLE, FIELD_TRIP_CONTENT, KINDERGARTEN_ID)
VALUES(SEQ_FIELD_TRIP.NEXTVAL, '숭어 얼음 낚시', '숭어 잡자 추워도 참아', 24);
INSERT INTO TBL_FIELD_TRIP(ID, FIELD_TRIP_TITLE, FIELD_TRIP_CONTENT, KINDERGARTEN_ID)
VALUES(SEQ_FIELD_TRIP.NEXTVAL, '커피 체험 공장', '커비 빈 객체화', 25);
INSERT INTO TBL_FIELD_TRIP(ID, FIELD_TRIP_TITLE, FIELD_TRIP_CONTENT, KINDERGARTEN_ID)
VALUES(SEQ_FIELD_TRIP.NEXTVAL, '치즈 제작하기', '여기 치즈 저기 치즈 전부 다 치즈', 21);
INSERT INTO TBL_FIELD_TRIP(ID, FIELD_TRIP_TITLE, FIELD_TRIP_CONTENT, KINDERGARTEN_ID)
...
INSERT INTO TBL_REPLY
VALUES(SEQ_REPLY.NEXTVAL, '댓글 테스트1', 3, 1);
...
SELECT * FROM TBL_CAR;
INSERT INTO TBL_CAR
VALUES(SEQ_CAR.NEXTVAL, '기아', '500만원','모닝', '2014-09-10');
INSERT INTO TBL_CAR
VALUES(SEQ_CAR.NEXTVAL, '삼성', '5000만원','SM6', '2015-09-10');
INSERT INTO TBL_CAR
VALUES(SEQ_CAR.NEXTVAL, '현대', '9000만원','제네시스', '2019-09-10');
INSERT INTO TBL_CAR
VALUES(SEQ_CAR.NEXTVAL, '기아', '5000만원','모닝3', '2011-09-10');
INSERT INTO TBL_CAR
VALUES(SEQ_CAR.NEXTVAL, '삼성', '5억','SM90', '2023-09-10');

SELECT * FROM TBL_OWNER;
INSERT INTO TBL_OWNER
VALUES(SEQ_OWNER.NEXTVAL, '가랑비', '오현준','01083011474', '서울시 성북구');
INSERT INTO TBL_OWNER
VALUES(SEQ_OWNER.NEXTVAL, '보슬비', '홍길동','01012341234', '서울시 도봉구');
INSERT INTO TBL_OWNER
VALUES(SEQ_OWNER.NEXTVAL, '산성비', '이순신','01012345678', '서울시 강남구');

SELECT * FROM TBL_REGISTRATION;
INSERT INTO TBL_REGISTRATION
VALUES(SEQ_REGISTRATION.NEXTVAL, '계약기간 3년', 1,1);
INSERT INTO TBL_REGISTRATION
VALUES(SEQ_REGISTRATION.NEXTVAL, '계약기간 5년', 1,2);
INSERT INTO TBL_REGISTRATION
VALUES(SEQ_REGISTRATION.NEXTVAL, '계약기간 3년', 2,3);
INSERT INTO TBL_REGISTRATION
VALUES(SEQ_REGISTRATION.NEXTVAL, '계약기간 1년', 3,4);
INSERT INTO TBL_REGISTRATION
VALUES(SEQ_REGISTRATION.NEXTVAL, '계약기간 3년', 3,5);
...
WHERE O.ID IN (
    ...
    JOIN TBL_CAR C 
    ON R.CAR_ID = C.ID
    WHERE C.CAR_BRAND = '기아'
);

SELECT O.*
FROM TBL_OWNER O
JOIN TBL_REGISTRATION R 
ON O.ID = R.OWNER_ID
JOIN TBL_CAR C 
ON R.CAR_ID = C.ID
WHERE C.CAR_BRAND = '기아';
...
ON O.ID = R.OWNER_ID AND REGISTRATION_CAR = '계약기간 3년';


/* 회원 별 차 조회*/
SELECT O.OWNER_NAME, C.CAR_MODEL_NAME  
FROM TBL_OWNER O JOIN TBL_REGISTRATION R
ON O.ID = R.OWNER_ID
JOIN TBL_CAR C
ON C.ID = R.CAR_ID; 
...
FROM TBL_REGISTRATION R
JOIN TBL_CAR C
ON C.ID = R.CAR_ID AND CAR_BRAND ^= '삼성'
);
...
SELECT OWNER_NAME, CAR_MODEL_NAME 
FROM TBL_OWNER O JOIN TBL_REGISTRATION R
ON O.ID = R.OWNER_ID
JOIN TBL_CAR C
ON C.ID = R.CAR_ID
...
ON O.ID = R.OWNER_ID 
JOIN TBL_CAR C
ON C.ID = R.CAR_ID AND C.CAR_DATE LIKE '2015';
